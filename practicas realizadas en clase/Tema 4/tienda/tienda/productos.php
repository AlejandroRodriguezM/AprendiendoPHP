<?php
	...
	if (!isset($_SESSION['cesta']))  //si la cesta no está definida todavía la inicializamos
		$_SESSION['cesta']=null;
...
<?php
    ...
    if (isset($_POST['vaciar'])) {
		...
		$_SESSION['cesta']=null; //para que después de vaciar la cesta no nos muestre el error de que la cesta no está definida
    }
