...
class CursoController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function show($id) //si aqui se le pone p.e. curso2, no se muestra nada
    {
        $curso = Curso::find($id);
        // return "<h1>Estás en el curso: $curso</h1>";
        return view('cursos.show', compact('curso')); //si aqui se le pone p.e. curso2, no se muestra nada
    }
