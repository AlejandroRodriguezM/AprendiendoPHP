...
<div style="margin-right: 78%;">
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <fieldset>
            ...
            <div class="mb-3">
                <input class="btn btn-primary form-control" type="submit" id="enviar" name="enviar" value="Cambiar" style="width: 35%;background-color: rgb(209, 207, 207); border-radius: 0; border-color: black; color: black; margin-right: 10%;">
                <input class="btn btn-primary form-control" type="submit" id="restablecer" name="restablecer" value="Restablecer" style="width: 35%;background-color: rgb(209, 207, 207); border-radius: 0; border-color: black; color: black;">
            </div>
        </fieldset>
    </form>
</div>
