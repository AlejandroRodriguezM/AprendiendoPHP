...
<head>
    ...
    <title>Eliminacion de venta</title>
</head>
...
<body>
    ...
    if (isset($_POST['del'])) {
        ...
        $sentenciaSQL = "DELETE FROM ventas WHERE refProducto='$refProducto';";
        operacionesMySql($sentenciaSQL, $base);
        header("Location:eliminacion_ventas.php");
    }
    ...
    <h1>Eliminando ventas<span class="subtitulo"></span></h1>
        ...
        <table width="50%" border="0" align="center">
            ...
            ?>
                <tr>
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <td class='bot'><input type='submit' name='del' id='del' onclick="return confirm('¿Estas seguro que quieres eliminar la venta?')" value='Eliminar'></td>
