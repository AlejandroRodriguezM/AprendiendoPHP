...
<head>
    ...
    <title>Indice de eliminación</title>
</head>
...
<body>
    <div class="contenedor">
        ...
        <p>Segun la opcion, podras eliminar datos </p>
        <div class="subMenu_botones">
            <input class="boton_indice" type="image" src="img/ventas.jpg" value="Eliminar venta" alt="Submit" width="150" height="150" onclick="location.href='eliminar/eliminacion_ventas.php';">
            <input class="boton_indice" type="image" src="img/producto.jpg" value="Eliminar producto" alt="Submit" width="150" height="150" onclick="location.href='eliminar/eliminacion_producto.php';">
